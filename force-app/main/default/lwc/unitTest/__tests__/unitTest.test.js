...
//We started nesting tests, using the describe opener 
describe('c-unit-test', () => {
  ...
  //Test 1 (Validating variable value)
  it('displays unit status with default unitNumber', () => {
    ...
    //Variable unitNumber expected to be 5
  ...
  //Test 2 (Validating variable value change)
  it('displays unit status with updated unitNumber', () => {
    ...
    //The change is not inmediate, we need to make a resolve first..
  ...
  //Test 3 (Validating input field onchange)
  it('displays unit status with input change event', () => {
    //Initialize the component
    const element = createElement('c-unit-test', {
      is: UnitTest
    });
    //Put the element in div
    document.body.appendChild(element);
    const div = element.shadowRoot.querySelector('div');
    ...
    //Expecting change and new variable value
    return Promise.resolve().then(() => {
